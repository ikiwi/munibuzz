...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        self.title = @"Stops Search";
        self.view.frame = CGRectMake(40,40,320,480);
    }
    return self;
}
...
- (void)viewDidLoad
{
    ...
    stopsSearchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0,0,320,40)];
    stopsSearchBar.delegate = self;
    stopsSearchBar.placeholder = @"Type a street name";
    ...
    self.tableView.tableHeaderView = stopsSearchBar;
